...
describe('Image Message Flow Tests', () => {
    ...
    describe('Image display in chat interface', () => {
        it('should display images in user messages with proper styling', async () => {
            ...
            expect(screen.getAllByText(/Image message containing/i)[0]).toBeInTheDocument()
        ...
        it('should display image-only messages without text', async () => {
            const mockMessage: Message = {
                id: 'msg_2',
                text: '',
                sender: 'user',
        ...
        it('should handle image error states with retry functionality', async () => {
        ...
        it('should display image metadata correctly', async () => {
            const mockMessage: Message = {
                id: 'msg_4',
                text: 'Receipt photo',
                sender: 'user',
            ...
            expect(screen.getAllByText(/800 by 600 pixels/)[0]).toBeInTheDocument()
        })
    })
