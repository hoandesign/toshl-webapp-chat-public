...
*   **Intent: "add"**
    ```json
    {
      ...
      "payloads": [ { /* ToshlEntryPayload object(s) - see rules below. Can be multiple entries. */ } ]
    }
    ```
...
*   **Example 20: Multiple Entries (Do NOT merge identical items)**
    *   Input: "20k nước, 40k nhà hàng, 100k nhà hàng"
    *   Output:
        ```json
        {
          "action": "add",
          "headerText": "Okay, logged your water and restaurant expenses.",
          "payloads": [
            {
              "amount": -20000, "currency": { "code": "VND" }, "date": "{{today}}",
              "account": "{{defaultAccountId}}", "category": "<category_id_drinks>",
              "desc": "nước"
            },
            {
              "amount": -40000, "currency": { "code": "VND" }, "date": "{{today}}",
              "account": "{{defaultAccountId}}", "category": "<category_id_food>",
              "desc": "nhà hàng"
            },
            {
              "amount": -100000, "currency": { "code": "VND" }, "date": "{{today}}",
              "account": "{{defaultAccountId}}", "category": "<category_id_food>",
              "desc": "nhà hàng"
            }
          ]
