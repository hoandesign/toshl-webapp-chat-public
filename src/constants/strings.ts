...
export const GEMINI_MODEL_HELP_TEXT = "Default: gemini-3.1-flash-lite-preview"; // Update if default changes
...
export const CLEAR_CHAT_HISTORY_CONFIRM = "Are you sure you want to clear all chat history? This action cannot be undone."; // Added
...
export const MESSAGE_PLACEHOLDER = "Type your request...";
...
export const DEFAULT_GEMINI_MODEL_VALUE = "gemini-3.1-flash-lite-preview"; // Default model name
...
export const CONFIRM_DELETE_ENTRY = (entryId?: string) =>
    entryId
        ? `Are you sure you want to delete entry ${entryId}? This action cannot be undone.`
