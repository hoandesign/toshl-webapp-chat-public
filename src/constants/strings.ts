...
export const GEMINI_MODEL_HELP_TEXT = "Default: gemini-2.5-flash"; // Update if default changes
...
export const DEFAULT_GEMINI_MODEL_VALUE = "gemini-2.5-flash"; // Default model name
